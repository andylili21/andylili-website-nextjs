...
export default function CyberFooter() {
  return (
    <motion.footer 
      className="bg-gradient-to-r from-gray-900 to-gray-800 border-t border-gray-800"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              这是一个现代化的个人网站，集博客、项目展示和时间管理于一体。
              采用前沿技术构建，为您提供流畅的浏览体验。
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/time-planning" className="text-gray-400 hover:text-cyan-400 transition-colors">
                  时间规划
                </Link>
              </li>
            </ul>
          ...
          {/* 联系信息 */}
          <div>
            <h3 className="text-lg font-semibold text-white mb-4">联系我</h3>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} 数字驾驶舱. 保留所有权利.
          </p>
        </div>
      </div>
    </motion.footer>
